...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/travis/.rvm/rubies/ruby-2.3.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/travis/.rvm/rubies/ruby-2.3.0' '--without-tcl' '--without-tk' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
